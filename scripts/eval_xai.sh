...
# python eval_xai.py --task xai_M2PF --head_name xai_head --checkpoint_file checkpoints/checkpoint_best_xai_apex_M2PF_0.00001_base_8.pt.pt --data_dir processed/xai_data_bin_apex_reg_cls_8bars/0
# python eval_xai.py --task xai_M2PF --head_name xai_head --checkpoint_file checkpoints/checkpoint_last_musicbert_small.pt --data_dir processed/xai_data_bin_apex_reg_cls_8bars/0
python eval_xai.py --task xai_M2PF --head_name xai_head --checkpoint_file checkpoints/checkpoint_last_musicbert_small.pt --data_dir processed/xai_data_bin_apex_reg_cls_8bars/0

# checkpoints_8bars/checkpoint_best_xai_apex_M2PF_0.00001_base_8.pt.pt